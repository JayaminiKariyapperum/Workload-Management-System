...
if(isset($_POST['SubmitSetting'])){
    ...
    $req_fields = array('CourseCode','NoOfStudents','radio_button','NoOfWeeks');
...
$req_fields = array('CourseCode','NoOfStudents','TotalTime','radio_button','NoOfWeeks');
...
if(empty($errors)){
 ...
 $Theory_Practical = isset($_POST['radio_button']) ? $_POST['radio_button'] : null;
  ...
  $query = "INSERT INTO seminar_course ( ";
  $query .=  "EmployeeID,CourseCode,TheoryPractical,NumberOfWeeks,NumberOfStudents,TotalTime,Academic_year,is_deleted";
  $query .= ") VALUES (";
  $query .=  "'{$_SESSION['EmployeeID']}','{$CourseCode}','{$Theory_Practical}','{$nweeks}','{$NoOfStudents}','{$TotalTime}','{$_SESSION['Academic_year']}',0";
  $query .= ")";
...
<head>
	...
	<title>Seminar Course Add New</title>
...
<body>
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
		<fieldset>
			...
			Credit base seminar course</legend>
...
?>
              <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <tr>
                    ...
                    <td></td> <td></td> <td></td>
  					<td><input type="text" id="NoOfWeeks" name="NoOfWeeks"  <?php echo 'value="' . $nw . '"'; ?>></td>
