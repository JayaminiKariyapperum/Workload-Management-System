...
<head>
	...
	<title>4th Year Research View</title>
...
<body>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       $sql = "SELECT ResNo,RegNo,StudentName,CourseCode,ResearchTitle,StartDate,EndDate,EvolutionTime FROM 4th_year_research WHERE EmployeeID = '{$_SESSION['EmployeeID']}' && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
           ...
           echo "<td>" . $row["EvolutionTime"] . "</td>";
		   echo "<td><a href='4thYearResEdit.php?id=" . $row["ResNo"] . "'>Edit</a></td>"; 
		   echo "<td><a href='4thYearResDelete.php?id=" . $row["ResNo"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="4thYearResAdd.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="4th_year_download.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
