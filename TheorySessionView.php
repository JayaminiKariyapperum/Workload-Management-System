...
<head>
	...
	<title>Theory Sessions View</title>
...
<body>
   ...
   <table class="table">
     <thead class="thead-dark">
       <tr>
         ...
         <th>Actual lecture time</th>




         <th>Credit Based Time</th>
		 <th>Lectures / Tutorials / Presentations</th>
     ...
     <tbody>
       ...
       $sql = "SELECT TNo,Year,Semester,CourseCode,NumberOfCredits,NumberOfStudents,ActualLectureTime,creditTime,quiz_ass_tu FROM academic_instructions_theory_lecture_sessions WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
		   ...
		   echo "<td>" . $row["quiz_ass_tu"] . "</td>";
		   echo "<td><a href='TheorySessionsEdit.php?id=" . $row["TNo"] . "'>Edit</a></td>"; 
		   echo "<td><a href='TheorySessionsDelete.php?id=" . $row["TNo"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="TheorySessionsAdd.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="theory_download.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
