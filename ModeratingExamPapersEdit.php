...
if(isset($_GET['id'])){
	...
	if($result_set){
		if(mysqli_num_rows($result_set) == 1){
			...
			// record not found
			header('Location: ModeratingExamPapersView.php?err=record_not_found');
			exit;
		}
	} else {
		// query unsuccessful
		header('Location: ModeratingExamPapersView.php?err=query_failed');
		exit;
	}
}
...
$totaltime = $_POST['TotalTime'];
  ...
  if(empty($errors)){
	...
	$query = "UPDATE moderating_exam_papers SET ";
  ...
  if($result){
    header('Location: ModeratingExamPapersView.php?user_added=true');
  }else{
...
<head>
	...
	<title>Moderating Exam Papers Edit</title>
...
<body>
	...
	<div class="breadcrumb">
        ...
        <li><a href="main.php">Home</a></li>
			...
			<li><a href="ModeratingExamPapersView.php">Moderating Exam Papers</a></li>
			<li>Edit</li>
		</ul>
	</div>
