...
<head>
	...
	<title>Moderating Exam Papers View P</title>
...
<body>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       $sql = "SELECT MEN,CourseCode,NumberOfCredits,TotalTime FROM moderating_exam_papersP WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
		   ...
		   echo "<td><a href='ModeratingExamPapersEditP.php?id=" . $row["MEN"] . "'>Edit</a></td>"; 
		   echo "<td><a href='ModeratingExamPapersDeleteP.php?id=" . $row["MEN"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="ModeratingExamPapersP.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="moderating_downloadP.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
