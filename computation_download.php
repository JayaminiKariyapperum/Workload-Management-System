...
require_once('inc/connection.php');
 ...
 $sql = "SELECT CourseCode,TheoryPractical,NumberOfStudents,TotalTime FROM computation_results WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
...
$pdf->Cell(0, 10, 'Computation of course results reports Workload Report', 0, 1, 'C');
