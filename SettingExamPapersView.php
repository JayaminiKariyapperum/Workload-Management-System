...
<head>
	...
	<title>Setting Exam papers View</title>
...
<body>
	...
	<div class="breadcrumbs">
		<ul class="bcm">
			...
			<li>Setting Exam papers view</li>
		</ul>
	</div>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       $sql = "SELECT SPN,CourseCode,NumberOfCredits,ActualTime,TotalTime FROM setting_exam_papers WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
		   ...
		   echo "<td><a href='settingExamPapersEdit.php?id=" . $row["SPN"] . "'>Edit</a></td>"; 
		   echo "<td><a href='settingExamPapersDelete.php?id=" . $row["SPN"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="SettingExamPapers.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="setting_exam_download.php"><button type="button" class="btn btn-info">Download</button></a>
