...
require_once('inc/connection.php');
 ...
 $sql = "SELECT CourseCode,TheoryPractical,NumberOfStudents,NumberOfAss,TotalTime FROM evolution_quiz_assignments_tutorials WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
...
$pdf->Cell(0, 10, 'Evolution of quiz/assignments/tutorials Workload Report', 0, 1, 'C');

$pdf->SetFont('Arial','B',10);
$pdf->cell(30,10,"Course code",1,0,'C');
$pdf->cell(30,10,"Theory/Practical",1,0,'C');
$pdf->cell(30,10,"No. of students",1,0,'C');
$pdf->cell(40,10,"No of assignments ",1,0,'C');
...
while($row = mysqli_fetch_array($result))
{
    ...
    $pdf->cell(40,10,$row['NumberOfAss'],1,0,'C');
