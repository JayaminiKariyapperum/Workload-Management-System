...
if(isset($_GET['id'])){
	...
	if($result_set){
		if(mysqli_num_rows($result_set) == 1){
			...
			// record not found
			header('Location: markingViewP.php?err=record_not_found');
			exit;
		}
	} else {
		// query unsuccessful
		header('Location: markingViewP.php?err=query_failed');
		exit;
	}
}
...
if(empty($errors)){
	...
	$query = "UPDATE marking_exam_papersP SET ";
...
<head>
	...
	<title>Marking Exam Papers Edit P</title>
...
<body>
	...
	<div class="breadcrumb">
        ...
        <li><a href="main.php">Home</a></li>
			...
			<li><a href="MarkingViewP.php">Marking Exam Papers</a></li>
			<li>Edit</li>
		</ul>
	</div>
