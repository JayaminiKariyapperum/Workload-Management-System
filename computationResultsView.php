...
<head>
	...
	<title>Computation of Course Results</title>
...
<body>
	...
	<div class="breadcrumbs">
		<ul class="bcm">
			...
			<li>Computation of course results </li>
		</ul>
	</div>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       $sql = "SELECT CRN,CourseCode,TheoryPractical,NumberOfStudents,TotalTime FROM computation_results WHERE EmployeeID = '{$_SESSION['EmployeeID']}' && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
		   ...
		   echo "<td><a href='computationResultsEdit.php?id=" . $row["CRN"] . "'>Edit</a></td>"; 
		   echo "<td><a href='computationResultsDelete.php?id=" . $row["CRN"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="computationResults.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="computation_download.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
