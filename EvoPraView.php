...
<head>
	...
	<title>Evaluation of Practical Reports</title>
...
<body>
	...
	<div class="breadcrumbs">
		<ul class="bcm">
			...
			<li>Evaluation of practical reports </li>
		</ul>
	</div>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       $sql = "SELECT EPR,CourseCode,NumberOfStudents,TotalTime FROM evolution_practical_reports WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
		   ...
		   echo "<td><a href='EvoPraEdit.php?id=" . $row["EPR"] . "'>Edit</a></td>"; 
		   echo "<td><a href='EvoPraDelete.php?id=" . $row["EPR"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="EvoPra.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="evo_pra_download.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
