...
require_once('inc/connection.php');
 ...
 $sql = "SELECT  CourseCode, Date, Title, Description, Number_Of_Students, Required_Time
             FROM practical_field_visits
             WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0"; $result = mysqli_query($connection, $sql);
...
$pdf->Cell(0, 10, 'Field Visits workload report', 0, 1, 'C');
...
$pdf->cell(30,10,"Required time",1,1,'C');
