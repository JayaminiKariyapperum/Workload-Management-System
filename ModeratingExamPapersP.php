...
if(isset($_POST['SubmitSetting'])){
    ...
    $req_fields = array('CourseCode','NuOfCredits');
...
if(empty($errors)){
  ...
  $query = "INSERT INTO moderating_exam_papersP ( ";
  $query .=  "EmployeeID,CourseCode,NumberOfCredits,TotalTime,Academic_year,is_deleted";
  $query .= ") VALUES (";
  $query .=  "'{$_SESSION['EmployeeID']}','{$CourseCode}','{$NoOfCredits}','{$TotalTime}','{$_SESSION['Academic_year']}',0";
  $query .= ")";
...
<head>
	...
	<title>Moderating Exam Papers P</title>
