...
if(empty($errors)){
 $course =mysqli_real_escape_string($connection,$_POST['course']);   
  ...
  $query = "INSERT INTO practical_viva_sessions ( ";
  $query .=  "EmployeeID,Course_Code,Date,Title,Description,Number_Of_Students,Required_Time,Academic_year,is_deleted";
  $query .= ") VALUES (";
  ...
  if($result){
    header('Location: PVivalSessionsView.php?user_added=true');
  }else{
...
<head>
      ...
      <title>P Viva Sessions Add New</title>
...
?>
            <form action="PVivalSessionsAdd.php" method="post">
                        <table align="center">
                    
                               <tr>
                                    <td><label for="date">Course Code :</label></td>
                                    <td><input type="text" placeholder="" id="course" name="course" <?php echo 'value="' . $course . '"'; ?>></td>
                              </tr>
                              <tr>
