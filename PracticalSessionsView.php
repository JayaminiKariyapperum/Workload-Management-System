...
<head>
	...
	<title>Practical Sessions View</title>
...
<body>
   ...
   <table class="table">
     <thead class="thead-dark">
       <tr>
         ...
         <th>Credit Based time</th>

         <th>Actual lecture time (hours)</th>
         <th>Preperation time for practical sessions (hours)</th>
     ...
     <tbody>
       ...
       $sql = "SELECT CNo,Year,Semester,CourseCode,NumberOfCredits,NumberOfStudents,creditTime,ActualLectureTime,PreperationTimeOfPracticalSessions FROM academic_instructions_practical_lecture_sessions WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
           ...
           echo "<td>" . $row["creditTime"] . "</td>";
           echo "<td>" . $row["ActualLectureTime"] . "</td>";
           echo "<td>" . $row["PreperationTimeOfPracticalSessions"] . "</td>";
          
		   echo "<td><a href='PracticalSessionsEdit.php?id=" . $row["CNo"] . "'>Edit</a></td>"; 
		   echo "<td><a href='PracticalSessionsDelete.php?id=" . $row["CNo"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="PracticalSessionsAdd.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="practical_download.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
