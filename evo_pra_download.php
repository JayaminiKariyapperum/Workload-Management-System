...
require_once('inc/connection.php');
 ...
 $sql = "SELECT CourseCode,NumberOfStudents,TotalTime FROM evolution_practical_reports WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
...
$pdf->Cell(0, 10, 'Evolution of practical reports Workload Report', 0, 1, 'C');
