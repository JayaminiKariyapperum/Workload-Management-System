...
require_once('inc/connection.php');
 ...
 $sql = "SELECT CourseCode,NumberOfCredits,NumberOfStudents,TotalTime FROM marking_exam_papersP WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
...
$pdf->Cell(0, 10, 'Marking Exam Papers Workload Report', 0, 1, 'C');
