...
if(empty($errors)){
 ...
 $Theory_Practical = isset($_POST['radio_button']) ? $_POST['radio_button'] : null;
  ...
  $query = "INSERT INTO evolution_quiz_assignments_tutorials ( ";
  $query .=  "EmployeeID,CourseCode,TheoryPractical,NumberOfAss,NumberOfStudents,TotalTime,Academic_year,is_deleted";
  $query .= ") VALUES (";
  $query .=  "'{$_SESSION['EmployeeID']}','{$CourseCode}','{$Theory_Practical}','{$NoOfAss}','{$NoOfStudents}','{$TotalTime}','{$_SESSION['Academic_year']}',0";
  $query .= ")";
...
<head>
	...
	<title>Evaluation of Quiz/Assignment Add New</title>
...
function clearInputs() {
  ...
  document.getElementById("NuOfAss").value = "";
...
<body>
	...
	<div class="breadcrumb">
		<ul class="bc">
			...
			<li><a href="EvoView.php">Marking Exam papers</a></li>
			<li>Add new</li>
		</ul>
	</div>
