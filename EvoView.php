...
<head>
	...
	<title>Evaluation of quiz/assignment</title>
...
<body>
	...
	<div class="topnavi" id="myTopnav">
	  	<div class="dropdowns">
			...
			<a href="TheorySessions.php">Theory Sessions</a>
				  <a href="PracticalSessions.php">Practical Sessions</a>
			      <a href="3rdYearProjects.php">Third Year Projects</a>
			      <a href="4thYearRes.php">Fourth Year Researches</a>
	    	</div>
	  </div> 
	...
	<div class="breadcrumbs">
		<ul class="bcm">
			...
			<li>Evolution of quiz/assigments/tutorials </li>
		</ul>
	</div>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       $sql = "SELECT EQN,CourseCode,TheoryPractical,NumberOfStudents,NumberOfAss,TotalTime FROM evolution_quiz_assignments_tutorials WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
           ...
           echo "<td>" . $row["TheoryPractical"] . "</td>";
           echo "<td>" . $row["NumberOfStudents"] . "</td>";
           echo "<td>" . $row["NumberOfAss"] . "</td>";
           echo "<td>" . $row["TotalTime"] . "</td>";
		   echo "<td><a href='EvoEdit.php?id=" . $row["EQN"] . "'>Edit</a></td>"; 
		   echo "<td><a href='EvoDelete.php?id=" . $row["EQN"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="EvoQuiz.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="evo_downloa.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
 ...
 <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
	...
	<div class="footer">
		<center><p>&copy;University of Vavuniya-FAS | UNI MANAGER Workload Management System</p></center>
	</div>
