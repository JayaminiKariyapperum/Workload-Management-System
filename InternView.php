...
<body>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       $sql = "SELECT InNo,RegNo,StudentName,CourseCode,Position,StartDate,EndDate,EvolutionTime FROM intern_supervision WHERE EmployeeID = '{$_SESSION['EmployeeID']}' && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
		   ...
		   echo "<td><a href='InternEdit.php?id=" . $row["InNo"] . "'>Edit</a></td>"; 
		   echo "<td><a href='InternDelete.php?id=" . $row["InNo"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="InternAdd.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="InternDownload.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
