...
<head>
	...
	<title>P Viva Sessions View</title>
...
<body>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       $sql = "SELECT PV_No,Course_Code,Date,Title,Description,Number_Of_Students,Required_Time FROM practical_viva_sessions WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
		   ...
		   echo "<td><a href='PVivalSessionsEdit.php?id=" . $row["PV_No"] . "'>Edit</a></td>"; 
		   echo "<td><a href='PVivalSessionsDelete.php?id=" . $row["PV_No"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="PVivalSessionsAdd.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="viva_download.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
