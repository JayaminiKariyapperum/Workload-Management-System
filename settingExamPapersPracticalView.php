...
<head>
	...
	<title>Setting Exam Papers Pratical View</title>
...
<body>
	...
	<div class="breadcrumbs">
		<ul class="bcm">
			...
			<li>Setting Exam papers Practical</li>
		</ul>
	</div>
   ...
   <table class="table">
     <thead class="thead-dark">
       <tr>
         ...
         <th>Actual time spent to setting the paper</th>
         <th>Total time</th>
		 <th>Edit</th>
		 <th>Delete</th>
                </tr>
     ...
     <tbody>
       ...
       $sql = "SELECT SPN,CourseCode,NumberOfCredits,ActualTime,TotalTime FROM setting_exam_papers_practical WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
		   ...
		   echo "<td><a href='settingExamPapersPracticalEdit.php?id=" . $row["SPN"] . "'>Edit</a></td>"; 
		   echo "<td><a href='settingExamPapersPracticalDelete.php?id=" . $row["SPN"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="SettingExamPapersPractical.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="setting_exam_download_practical.php"><button type="button" class="btn btn-info">Download</button></a>
