...
require_once('inc/connection.php');
 ...
 $sql = "SELECT CourseCode,NumberOfCredits,TotalTime FROM moderating_exam_papersP WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
