...
require_once('inc/connection.php');
 ...
 $sql = "SELECT CourseCode,NumberOfCredits,NumberOfStudents,TotalTime FROM marking_exam_papers WHERE EmployeeID = '{$_SESSION['EmployeeID']}'  && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
